    ...
    <>
      <label className="grid grid-cols-3">
        <span className="col-span-2">
          ...
          <span className="text-pink-600">{a.format("Do MMMM, YYYY")}</span>
          ...
          <div className="flex justify-center">
            <button className="bg-sky-300 hover:text-white hover:bg-sky-500 py-2 px-4 mt-3 rounded items-center uppercase">
